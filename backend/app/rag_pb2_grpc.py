...
class ProductServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetProducts = channel.unary_unary(
                '/rag.ProductService/GetProducts',
                request_serializer=rag__pb2.Empty.SerializeToString,
                response_deserializer=rag__pb2.ProductList.FromString,
...
def add_ProductServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetProducts': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=rag__pb2.ProductList.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'rag.ProductService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('rag.ProductService', rpc_method_handlers)
...
class ProductService(object):
    ...
    def GetProducts(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            rag__pb2.ProductList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
